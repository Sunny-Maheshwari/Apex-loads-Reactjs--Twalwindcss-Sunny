        ...
        <div className="flex justify-between items-center">
          ...
          <ul className="hidden md:flex space-x-4 lg:space-x-8">
            <li className="relative group">
              <button className="hover:underline cursor-pointer pb-2">
                Transporters
              </button>
              <ul className="w-48 absolute hidden group-hover:block bg-black text-white py-2 space-y-2 rounded shadow-md top-full left-0">
                <li className="px-4 py-2 hover:bg-gray-700 transition-colors duration-200">
            ...
            <li className="relative group">
              <button className="hover:underline pb-2">
                Full Service Broker
              </button>
              <ul className="w-48 absolute hidden group-hover:block bg-black text-white py-2 space-y-2 rounded shadow-md top-full left-0">
                <li className="px-4 py-2 hover:bg-gray-700 transition-colors duration-200">
            ...
            <ul className="space-y-2">
              <li>
                ...
                <ul className="pl-4 space-y-2">
                  <li>
                    <a href="#search-loads" className="block py-1">
                      Search Loads
                    </a>
                  </li>
                  <li>
                    <a href="#post-truck" className="block py-1">
                      Post A Truck
                    </a>
                  </li>
                  <li>
                    <a href="#eac-profile" className="block py-1">
                      EAC Profile
                    </a>
                  </li>
                </ul>
              ...
              <li>
                ...
                <ul className="pl-4 space-y-2">
                  <li>
                    <a href="#option1" className="block py-1">
                      Option 1
                    </a>
                  </li>
                  <li>
                    <a href="#option2" className="block py-1">
                      Option 2
                    </a>
                  </li>
                </ul>
              ...
              <li>
                ...
                <ul className="pl-4 space-y-2">
                  <li>
                    <a href="#option3" className="block py-1">
                      Option 3
                    </a>
                  </li>
                  <li>
                    <a href="#option4" className="block py-1">
                      Option 4
                    </a>
                  </li>
                </ul>
